# VCC Launch Package Index

Prepared: August 1, 2026

Company: VILIGANS COMMAND CORPORATION

Operating division/subsidiary path: DOCS 8404 Logistics & NEMT LLC
...
This folder converts the launch-readiness requirements into working drafts that can be reviewed, approved, signed, filed, or sent externally when ready.

These files are not executed records. They should not be represented as final corporate, legal, grant, insurance, lending, regulatory, or certification documents until approved by the proper officer, board, counsel, CPA, broker, agency, lender, or grant partner as applicable.

## File Map

| File | Use |
|---|---|
| `01_Executive_Summary_DRAFT.md` | Replacement source for the zero-byte executive summary PDF found in the binder. |
| `02_Capability_Statement_DRAFT.md` | One-page partner/funder/lender capability statement source. |
| `03_Corporate_Governance_Action_Packet_DRAFT.md` | Governance checklist and draft resolutions needed before external submissions. |
| `04_SAM_VetCert_Readiness_Packet_DRAFT.md` | SAM/UEI, Grants.gov, and SBA VetCert readiness checklist. |
| `05_WYDOT_Insurance_Vehicle_Readiness_Packet_DRAFT.md` | Operating authority, insurance, vehicle, and launch stop/go gates. |
| `06_NEMT_Operations_Manual_DRAFT.md` | Draft operating policies for a controlled rural special-needs transportation pilot. |
| `07_90_Day_Pilot_Budget_DRAFT.md` | Working startup and 90-day operating budget. |
| `08_Partner_MOU_Template_DRAFT.md` | Draft MOU for anchor partners, VSOs, clinics, senior centers, counties, and disability providers. |
...
| `61_Minimum_Funding_Stack_And_Cash_Trigger_Memo_2026-08-02.md` | Path-specific cash trigger memo for deciding whether one-week funding and August 15 vehicle control are realistic enough to count. |
...
| `66_Partner_Vehicle_Pivot_Packet_2026-08-03.md` | Partner-vehicle fallback packet for preserving August 15 capacity if rental, lease, purchase, insurance, authority, or funding proof slips. |
| `67_Partner_Vehicle_Capacity_Target_Register_2026-08-03.csv` | Target register for local partner-vehicle and transportation-resource capacity screens, including Platte ParaTransit and Services for Seniors. |
| `68_Corporate_Email_Agent_And_Send_Approval_Runbook_2026-08-03.md` | Workspace-agent runbook for the Gmail-connected VCC Corporate Email Approval Agent and exact approval language. |
...
| `73_Launch_Automation_Agent_Roster_2026-08-04.md` | Recommended automation-agent roster for proof intake, launch gating, authority, insurance, funding, partner capacity, grants, workspace security, and compliance binder controls. |
| `74_August_4_Current_Reality_And_Approval_Lock_2026-08-04.md` | Current August 4 realism answer, public-source refresh, DNS/DKIM status, and exact approval lock for Batch A no-obligation proof collection. |
| `75_Daily_Launch_Gate_Report_2026-08-04.md` | Generated daily launch gate report from the proof clock and Batch A response worksheet, including countable proof totals and next approval text. |
| `76_Batch_A_No_Obligation_Contact_Run_Sheet_2026-08-04.md` | Generated no-obligation contact run sheet for the seven Batch A proof targets, including scripts, capture fields, stop rules, and countability rules. |
| `77_Batch_A_Response_Reconciliation_Map_2026-08-04.md` | Generated reconciliation map showing exactly where Batch A responses must land in the main intake, evidence log, scorecard, and proof clock before they count. |
...
19. Review the minimum funding stack and cash trigger memo in `61_Minimum_Funding_Stack_And_Cash_Trigger_Memo_2026-08-02.md`.
...
28. Use `73_Launch_Automation_Agent_Roster_2026-08-04.md` to create only the internal automation agents that preserve proof, send, filing, funding, insurance, payment, DNS/admin, and PHI approval gates.
29. Review `74_August_4_Current_Reality_And_Approval_Lock_2026-08-04.md` for the current realism answer, public-source refresh, unresolved website/DKIM evidence, and exact Batch A approval lock.
30. Run `npm run proof:daily-gate-report` after proof-clock or Batch A response changes, then use `75_Daily_Launch_Gate_Report_2026-08-04.md` for the current daily stop/go readout.
31. Run `npm run proof:batch-a-contact-run-sheet` after proof worksheet changes, then use `76_Batch_A_No_Obligation_Contact_Run_Sheet_2026-08-04.md` only after exact contact approval.
32. Run `npm run proof:batch-a-reconciliation-map` after proof worksheet, intake, evidence, scorecard, or proof-clock changes, then use `77_Batch_A_Response_Reconciliation_Map_2026-08-04.md` before counting any response.
33. Publish the VCC Corporate Email Approval Agent only after CEO approval, then use `68_Corporate_Email_Agent_And_Send_Approval_Runbook_2026-08-03.md` and `69_Corporate_Email_Agent_Send_Batch_Register_2026-08-03.csv` to prepare exact Gmail send approvals without unapproved obligations.
34. Choose Option A, B, or C in `55_CEO_Next_Action_Decision_Record_2026-08-02.md` before any outside contact or draft replacement.
35. If Option A is approved, use `57_Option_A_Same_Day_Proof_Collection_Runbook_2026-08-02.md` for the same-day proof collection order.
36. If a rental, vehicle, insurance, sponsor, lender, or partner-vehicle proof item appears, use `58_Bridge_Readiness_Funding_Authorization_DRAFT_2026-08-02.md` before any bridge/readiness funds are committed.
37. Use `59_Exact_Obligation_Approval_Memo_DRAFT_2026-08-02.md` before approving any specific deposit, rental, lease, purchase, insurance bind, filing, credit pull, invoice, funds acceptance, or partner-vehicle obligation.
38. Verify recipient emails and use the Gmail packet queue to prepare approved drafts.
39. Send partner, vehicle, and funding outreach only after final approval.
40. Convert approved summary/capability statement into PDF.
...
- Contract, MOU, sponsorship, or grant submission
